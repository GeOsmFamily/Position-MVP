    ...
    <div class="row">
      <div class="col-md-12">
        <div class="alert alert-warning fade show" role="alert">
          ...
          <p class="mb-0">
            All Bootstrap 4 helper classes available in the official Bootstrap
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-sm">
            <div class="clearfix">
              <div
                class="d-inline-block float-left h-50p bg-light p-5 mr-5 mb-5"
              >
                50px
              </div>
              <div
                class="d-inline-block float-left h-75p bg-light p-5 mr-5 mb-5"
              >
                75px
              </div>
              <div
                class="d-inline-block float-left h-100p bg-light p-5 mr-5 mb-5"
              >
                100px
              </div>
              <div
                class="d-inline-block float-left h-125p bg-light p-5 mr-5 mb-5"
              >
                125px
              </div>
            </div>
            <div class="table-wrap mt-40">
              <table class="table table-bordered mb-0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0"
                        >class="h-[value]p"</code
                      >
                    </td>
                    <td class="font-14">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-sm">
            <div class="h-200p">
              <div
                class="d-inline-block float-left h-auto bg-light p-5 mr-5 mb-2"
              >
                auto
              </div>
              <div
                class="d-inline-block float-left h-25 bg-light p-5 mr-5 mb-2"
              >
                25%
              </div>
              <div
                class="d-inline-block float-left h-50 bg-light p-5 mr-5 mb-2"
              >
                50%
              </div>
              <div
                class="d-inline-block float-left h-75 bg-light p-5 mr-5 mb-2"
              >
                75%
              </div>
              <div
                class="d-inline-block float-left h-100 bg-light p-5 mr-5 mb-2"
              >
                100%
              </div>
            </div>
