        ...
        <b-col lg="6">
          <div class="main-card mb-3 card">
            <div class="card-body">
              ...
              >
                <b-button class="mr-2 mb-2" :key="index" :variant="variant">
                  {{ variant }}
                </b-button>
              </template>
            </div>
        ...
        <b-col lg="6">
          <div class="main-card mb-3 card">
            <div class="card-body">
              ...
              >
                <b-button
                  class="mr-2 mb-2 btn-transition"
                  :key="index"
                  :variant="variant"
                >
                  {{ variant }}
        ...
        <b-col lg="6">
          <div class="main-card mb-3 card">
            <div class="card-body">
              ...
              >
                <b-button
                  class="mr-2 mb-2 border-0 btn-transition"
                  :variant="variant"
                  :key="index"
                >
                  {{ variant }}
        ...
        <b-col lg="6">
          <div class="main-card mb-3 card">
            <div class="card-body">
              ...
              >
                <b-button
                  class="mr-2 mb-2 btn-hover-shine btn-transition"
                  :variant="variant"
                  :key="index"
                >
                  {{ variant }}
        ...
        <b-col lg="6">
          <div class="main-card mb-3 card">
            <div class="card-body">
              ...
              <template v-for="(size, index) in ['sm', '', 'lg']">
                <b-button
                  block
                  class="mr-2 mb-2"
                  variant="primary"
