      ...
      <b-tab title="Profil" active
        ><div class="main-content">
          ...
          <div
            ...
            style="
              min-height: 600px;
              background-image: url(https://i.ibb.co/tJ7YrWd/position-motif.jpg);
            ...
            <div class="container-fluid d-flex align-items-center">
              <div class="row">
                <div class="col-lg-7 col-md-10">
                  ...
                  <a href="#!" class="btn btn-info">Modifier le profil</a>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div class="col">
                        ...
                        >
                          <div>
                            ...
                            <span class="description">Points collectés</span>
                          </div>
                          <div>
                            <span class="heading">10</span>
                            <span class="description">Moyenne journalière</span>
                          </div>
                          <div>
                            <span class="heading">89</span>
                            <span class="description">Rang global</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="text-center">
                      <h3>
                        {{ commercial.name
                          ...
                          numéro {{ commercial.numeroBadge }}</span
                        >
                      </h3>
                      <div class="h5 font-weight-300">
                        <i class="ni location_pin mr-2"></i
                        >{{ commercial.ville }}, {{ commercial.quartier }}
                      </div>
                      <div class="h5 mt-4">
