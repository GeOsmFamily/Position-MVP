...
url_demo=environment.url_demo
  constructor(private meta: Meta,private router:Router,private modalService: NgbModal,private activatedRoute:ActivatedRoute,private componentHelper:ComponentHelper)
     {
  ...
  shareLink() {
    ...
    var url_share =  environment.url_frontend+"home/?etablissements="+this.featurePoint?.get("id")+",16"
  ...
  open(featurePoint:any){
    ...
    this.meta.updateTag({property: 'og:title', content: this.featurePoint?.get("textLabel")});
    this.meta.updateTag({property: 'og:description', content: this.featurePoint?.get("nomCategorie")+","+this.featurePoint?.get("nomSousCategorie")});
    this.meta.updateTag({property: 'og:image', content: this.url_position+this.featurePoint?.get("cover")});
    this.meta.updateTag({property: 'og:url', content: environment.url_frontend+"?etablissements="+this.featurePoint?.get("id")+",16"})
...
console.log("closing")
  ...
  /*  console.log(this.featurePoint)
   ...
   alert(this.featurePoint?.get("telephones")[0].principal)
     ...
     console.log( this.url_position+"?etablissements="+this.featurePoint?.get("id")+",16")
  }
